...
import 'package:bms_shopping_app/feature/product_details/bloc/product_details_bloc.dart';
...
class _ProductDetailsScreenState extends State<ProductDetailsScreen> {
        ...
        child: Container(
          ...
          child: ElevatedButton(
            style: ElevatedButton.styleFrom(
              ...
              primary: _isAddedToBag ? AppColors.paleVioletRed : AppColors.indianRed,
            ),
  ...
  void onSelectedSize(int index, double size) {
    setState(() {
  ...
  void addProductToCart() {
    context.read<ProductDetailsBloc>().add(AddProductToCart(product));
  }

  void addToWishlistClick() {
    context.read<ProductDetailsBloc>().add(AddToWishlistEvent(product));
  }
}
