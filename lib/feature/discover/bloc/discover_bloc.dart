...
import 'package:bms_shopping_app/feature/discover/repository/firebase_discover_repository.dart';
...
class DiscoverBloc extends Bloc<DiscoverEvent, DiscoverState> {
  ...
  Stream<DiscoverState> _mapLoadDiscoverEvent(
    ...
    _streamSubscription = _discoverRepository.getListProduct().listen((products) {
  ...
  Stream<DiscoverState> _mapDiscoverUpdatedEventToState(
    ...
    final filterList = event.products.where((element) {
  ...
  Stream<DiscoverState> _mapLoadWishlistEvent(
    ...
    _streamSubscription = _discoverRepository.getListProduct().listen((products) {
      final filterList = products.where((element) {
